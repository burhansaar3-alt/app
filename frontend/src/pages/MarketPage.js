            ...
            <div className="flex gap-4 overflow-x-auto pb-4 scrollbar-hide">
              ...
              >
                <div className={`w-16 h-16 md:w-20 md:h-20 rounded-full flex items-center justify-center text-2xl md:text-3xl transition-all ${
                  !selectedSubcategory ? 'bg-blue-500 text-white shadow-lg' : 'bg-white border-2 border-blue-200 hover:border-blue-500'
                }`}>
                  🛒
                </div>
              ...
              {marketCategory.subcategories.map((sub) => (
                ...
                >
                  <div className={`w-16 h-16 md:w-20 md:h-20 rounded-full flex items-center justify-center text-2xl md:text-3xl transition-all ${
                    selectedSubcategory === sub.id ? 'bg-blue-500 text-white shadow-lg' : 'bg-white border-2 border-blue-200 hover:border-blue-500'
                  }`}>
                    {sub.icon}
                  </div>
